...
void main()
{
    ...
    network.train(data, all_y_trues, 0.001, 50000);

    //std::vector<double> Weights = network.m_Weights, Bias = network.m_Bias;

    std::vector<double> emily = { -6, -30, 63 };    //{ -7, -33, 20 };  //{ 151.76, 47.83, 63.0 };  //{ -6, -30, 63 };
    std::vector<double> frank = { -11, -54, 63 };   //{ 4, 64, 20 };   //{ 139.70, 36.49, 63.0 };  //{ -11, -54, 63 };
